...
var arrs = ["Huyện Thanh Oai", "Huyện Chương Mỹ", "Thành Phố Hà Nội", "Tỉnh Thanh Hoá", "Xã Cao Viên"
    ...
    , "Số 26 ngõ 16 XYZ, đường C, phường A, quận B"
...
,"Đường số 1, Tổ 5, Ấp Cây Sao, Hàm Ninh, Huyện Phú Quốc, Kiên Giang", "Số 8 Ngõ 123 Nhà Hỏa, Hàng Bồ, Hoàn Kiếm, Hà Nội"
,"28 Thanh Hóa, Tân An, Thành phố Hội An, Quảng Nam", "24 Bà Huyện Thanh Quan, Phường Thới Binh, Quận Ninh Kiều, Cần Thơ"]
// console.log(flatWord(arr[0]))
arr2.forEach(function (t) {
    console.log(converter.convertMulti(t))
})